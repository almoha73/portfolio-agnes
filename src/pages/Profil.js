          ...
          <div className="box flex justify-evenly items-center lg:flex-row  flex-col-reverse sm-w-9/12 w-10/12 bg-neutral-100 rounded-lg p-3 sm:p-5">
            <div className="w-11/12 sm:w-9/12 sm:gap-10 flex sm:flex-col flex-col justify-center items-center">
              ...
              <p className="text md:w-4/5 md:text-xl mt-5  text-justify break-all	">
                ...
                <br />
                <br /> Pour ce qui est du style, je code beaucoup en <span className="font-bold">Sass</span> , mais
                aussi en <span className="font-bold">Tailwind</span> et <span className="font-bold">Bootstrap</span> que j'ai appris en plus de ma
                formation, Tailwind étant mon préféré des frameworks css que
                j'utilise.
                <br />
                <br />
                Vous trouverez dans mon portfolio mes projets personnels, suivis
                de mes projets de formation. Actuellement, je m'approprie{" "}
                <span className="font-bold">NextJS </span>
                et <span className="font-bold">Typescript</span> pour continuer
                à évoluer avec React avec un site de mémo relié à une base de
                données où je peux joindre des fichiers (photos, pdf, ...).
                <br />
                <br />
                ...
                Mais j'ai aussi appris à utiliser <span className="font-bold">Figma</span>  pour créer des maquettes
                et j'ai été initiée aux méthodes agiles (<span className="font-bold">SCRUM</span>).
                <br />
